...
```
{
	"cursor": "/Users/latona2/bitbucket/sap-api-integrations-maintenance-bom-reads-rmq-kube/SAP_API_Caller/caller.go#L73",
	"function": "sap-api-integrations-maintenance-bom-reads-rmq-kube/SAP_API_Caller.(*SAPAPICaller).Header",
	"level": "INFO",
	"message": [
		{
